    ...
    <div class="container">
        <div class="player">
            ...
            <?php if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['roll'])): ?>
                ...
                <img src="PHPclass2024/img/dice_<?php echo $player_roll1; ?>.png" alt="Dice <?php echo $player_roll1; ?>">
                <img src="PHPclass2024/img/dice_<?php echo $player_roll2; ?>.png" alt="Dice <?php echo $player_roll2; ?>">
            <?php endif; ?>
        </div>
        ...
        <div class="computer">
            ...
            <?php if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['roll'])): ?>
                <?php for ($i = 0; $i < 3; $i++): ?>
                    ...
                    <img src="PHPclass2024/img/dice_<?php echo $computer_roll; ?>.png" alt="Computer dice <?php echo $computer_roll; ?>">
                <?php endfor; ?>
            <?php endif; ?>
        </div>
    </div>
